...
# Explain.
# I assigned my name as a string, since it is a collection of letters in order with meaning.
# I assigned a boolean data type to is_hungry since a true or false value is appropriate.
# I assigned an integer value to number_of_pets since the number of pets someone has is a whole number.
